...
let myButtonId= document.getElementById ("the-button")
let myParagraphId= document.getElementById ("your-total-clicks")

let innerTextOfClicks= 0
myButtonId.addEventListener ("click", () =>{
    innerTextOfClicks++
   myParagraphId.innerText= innerTextOfClicks
})
